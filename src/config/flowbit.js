...
export default { button, drawer, footer, input, avatar, tab, checkbox, authDialog, adminSettingsTabs, table, dashSide, customThemeDatePicker, customInlineDatePicker }