...
const botDialog = {
    "root": {
        "base": "fixed inset-x-0 top-0 rounded-lg z-40 h-screen overflow-y-auto overflow-x-hidden md:inset-0 md:h-full",
        "show": {
            "on": "flex bg-gray-900 bg-opacity-50 dark:bg-opacity-80",
            "off": "hidden"
        },
    ...
    "content": {
        "base": "relative w-full p-0 h-auto rounded-lg",
        "inner": "relative flex max-h-[95dvh] p-0 flex-col rounded-lg bg-white shadow dark:bg-gray-700"
    },
    "body": {
...
export default { button, drawer, footer, input, avatar, tab, checkbox, authDialog, adminSettingsTabs, table, dashSide, customThemeDatePicker, customInlineDatePicker, botDialog }